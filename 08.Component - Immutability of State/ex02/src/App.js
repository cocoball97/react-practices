        ...
        <div id='App'>
            <button 
                onClick={() => {
                    ...
                    // sol.
                    // const orderUpdated = Object.assign({}, order, {receive: "서울시 은평구 논현동..."});
            ...
            <button 
                onClick={() => {
                    ...
                    // orderUpdated.payment.method = 'Modbile';
                    // setPayment(orderUpdated.payment);

                    //sol.
                    // const orderUpdated = Object.assign({}, order);
                    // orderUpdated.payment = Object.assign({}, order.payment, {method: 'Modbile'});
                    // setPayment(orderUpdated.payment);
            ...
            <button 
                onClick={() => {
                    ...
                    // 중간에 입력
                    // const goodsUpdated = [...goods.slice(0, 1),{"no": "c002-003","name": "블루양말","price": 2000,"amount": 1}, ...goods.slice(1)]
                    // setGoods(goodsUpdated);
            ...
            <button
                onClick={() => {
                    ...
                    // sol
                    // const goodsUpdated = [...goods.slice(0, 2), 
